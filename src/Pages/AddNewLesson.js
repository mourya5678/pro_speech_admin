...
const AddNewLesson = () => {
    ...
    const onHandleAddLessonDetail = async () => {
        ...
        if (name && data) {
            ...
            var apiResponse = await pipApiResponse('post', `${baseUrl + updateLessonEndPointURL}`, headers, true, dataas);
            setIsLoader(false);
                                        ...
                                        <div className="card-body pt-5">
                                            <div className="card-head-row card-tools-still-right mb-5">
                                                <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap w-100">
                                                    ...
                                                    <h4 className="card-title ct_fw_700 mb-0 mx-auto">Add New Lesson</h4>
                                                </div>
                                            </div>
                                            <form className="pt-0">
